    ...
    public partial class UriTests
    {
        ...
        public void TestAbsoluteVSOriginal()
        {
            ...
            */  
            ...
            Assert.Equal(uri_01.AbsoluteUri, "http://xamarin.com/");
            Assert.Equal(uri_02.AbsoluteUri, "http://xamarin.com/");


            Assert.Equal(uri_01.OriginalString, "http://xamarin.com/");
            Assert.Equal(uri_02.OriginalString, "http://xamarin.com");
