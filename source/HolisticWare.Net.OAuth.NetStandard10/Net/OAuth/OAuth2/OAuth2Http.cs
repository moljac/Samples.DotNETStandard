...
namespace HolisticWare.Net.Http
{
    ...
    public class OAuth2Http
    {
        ...
        public string OAuthQueryParametersAsString(Dictionary<string, string> parameters)
        {
            OAuthQueryParameters query_parameters = new OAuthQueryParameters(parameters);

            string query_parameters_string = query_parameters.ToString();

            return query_parameters_string;
        }
    }
}
